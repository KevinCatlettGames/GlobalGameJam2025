...
public class SO_Rapid : SO_Spell
{
    public override float CastSpell(int ID, Vector3 pos, Vector3 dir, Collider playerCollider, bool isUlt, ulong senderClientId, int assignedCastID)
    {
        ...
        if (NetworkManager.Singleton.IsServer)
        {
            ...
            oneWayTime += Time.fixedDeltaTime / 2f;
            ...
            script1.InitialiseBubble(ID, dir, playerCollider, assignedCastID, false);
            ...
            script2.InitialiseBubble(ID, dir, playerCollider, assignedCastID, false);
        ...
        if (!NetworkManager.Singleton.IsServer && NetworkManager.Singleton.LocalClientId == senderClientId)
        {
            ...
            if (fakeScript1 != null)
            {
                ...
                fakeScript1.InitialiseBubble(ID, dir, playerCollider, assignedCastID, false);
            }
            ...
            if (fakeScript2 != null)
            {
                ...
                fakeScript2.InitialiseBubble(ID, dir, playerCollider, assignedCastID, false);
            }
